...
SRC_URI="https://api.github.com/repos/Enlightenment/enlightenment/tarball/refs/tags/v0.25.0 -> enlightenment-0.25.0.tar.gz"
...
fix_src_dirs() {
	pushd "${WORKDIR}"
	mv Enlightenment-enlightenment-* enlightenment-0.25.0
	popd
}
