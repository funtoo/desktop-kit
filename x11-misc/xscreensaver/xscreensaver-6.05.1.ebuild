...
SRC_URI="https://jwz.org/xscreensaver/xscreensaver-6.05.1.tar.gz -> xscreensaver-6.05.1.tar.gz"

LICENSE="BSD"
SLOT="0"
KEYWORDS="*"
IUSE="+gdk-pixbuf +gtk jpeg +locking new-login offensive +opengl pam +perl selinux suid xinerama"
REQUIRED_USE="
	gdk-pixbuf? ( gtk )
"
...
src_install() {
	# This dir must exist for xscreensaver make install to install PAM files:
	dodir /etc/pam.d
